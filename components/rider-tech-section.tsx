...
export default function RiderTechSection() {
  return (
    <section id="sobre-mim" className="relative min-h-screen bg-white px-6 md:px-12 overflow-visible py-12 md:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight leading-tight inline-block">
            <span className="font-sans text-lorenzo-dark">SOBRE</span>{" "}
            <span className="font-brier text-lorenzo-dark text-9xl">MIM</span>
          </h2>
        </motion.div>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          >
            <p className="text-base md:text-lg leading-relaxed text-lorenzo-dark">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div className="space-y-6 order-1 md:order-2">
                  <h3 className="text-3xl md:text-4xl font-bold text-lorenzo-dark font-oswald uppercase tracking-wide">
                    EVA.Tech
                  </h3>
                  <p className="text-base md:text-lg leading-relaxed text-lorenzo-dark">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center text-lorenzo-accent hover:text-lorenzo-accent/80 transition-colors font-medium"
                  >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: 0.5 }}
                  className="relative w-full rounded-xl overflow-hidden shadow-xl order-1 md:order-2"
